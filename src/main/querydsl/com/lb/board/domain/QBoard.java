...
public class QBoard extends EntityPathBase<Board> {
    ...
    private static final long serialVersionUID = 1302394351L;
    ...
    public final StringPath lectureDivide = createString("lectureDivide");

    public final StringPath lectureName = createString("lectureName");

    public final StringPath lectureYear = createString("lectureYear");
    ...
    public final StringPath semesterDivide = createString("semesterDivide");
